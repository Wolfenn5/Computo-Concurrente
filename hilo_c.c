...
void * muestra_Contador() // estas funciones necesitan recibir los parametros como un apuntador de tipo void
{
    while (contador<=10)
    {
...
int main(int argc, char const *argv[])
{
    ...
    pthread_create(&hilo1, NULL, muestra_Contador, NULL); // aqui se le asigna que instrucciones hara el hilo    
